        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-8 md:gap-12 lg:gap-20 border-b border-gray-700 pb-10">
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li><Link to='/shop' className="text-gray-400 hover:text-white transition duration-300">Shop</Link></li>
              <li><Link to='/' className="text-gray-400 hover:text-white transition duration-300">About</Link></li>
          ...
          <div>
            ...
            <div className="flex space-x-4 mb-4">
              <a href="#" aria-label="Facebook" className="p-2 border border-gray-600 rounded-full hover:bg-white hover:text-gray-800 transition duration-300">
                <FaFacebookF size={16} />
              </a>
              <a href="#" aria-label="Twitter" className="p-2 border border-gray-600 rounded-full hover:bg-white hover:text-gray-800 transition duration-300">
                <FaGithub size={16} />
              </a>
              <a href="#" aria-label="Instagram" className="p-2 border border-gray-600 rounded-full hover:bg-white hover:text-gray-800 transition duration-300">
                <FaInstagram size={16} />
              </a>
              <a href="#" aria-label="LinkedIn" className="p-2 border border-gray-600 rounded-full hover:bg-white hover:text-gray-800 transition duration-300">
