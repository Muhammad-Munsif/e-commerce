      ...
      <div className='container mx-auto mt-2 px-4 md:px-16 lg:px-24 grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-5'>
        {
            infoItems.map((item, index) =>(
                <div key={index} className='flex flex-col items-center text-center p-4 border-1 border-gray-300 rounded-lg shadow-md transform transition-transform duration-300 hover:scale-105 cursor-pointer'>
                    {item.icon}
