...
const Beauty = () => {
  ...
  return (
    <div className="min-h-screen bg-gradient-to-br from-rose-50 to-pink-50 container mx-auto mt-40 px-4 md:px-16 lg:px-8 py-4 flex flex-col md:flex-row space-x-2">
