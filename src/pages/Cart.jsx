                        ...
                        <div className='lg:w-2/3'>
                            ...
                            <div className='space-y-4'>
                                {cart.products.map((product) => (
                                    <div key={product.id} className='bg-white rounded-lg border border-gray-200 p-4 hover:shadow-md transition-shadow duration-200'>
                                        {/* Mobile Layout */}
                                        <div className='md:hidden flex flex-col space-y-4'>
                                            ...
                                            <div className='flex justify-between items-center'>
                                                ...
                                                <div className='text-right'>
                                                    ...
                                                    <button className='text-red-500 hover:text-red-700 mt-2 p-1'>
                                        ...
                                        <div className='hidden md:grid grid-cols-12 gap-4 items-center'>
                                            ...
                                            <div className='col-span-2 flex justify-center'>
                                                <div className='flex items-center border border-gray-300 rounded-lg'>
                                                    ...
                                                    <span className='px-4 py-2 font-medium min-w-12 text-center'>{product.quantity}</span>
                                                    <button className='p-2 hover:bg-gray-100 transition-colors'>
                                                        <FaPlus className='w-3 h-3 text-gray-600' />
                                                    </button>
                                                </div>
                                            ...
                                            <div className='col-span-2 text-center'>
                                                <p className='text-gray-900 font-bold'>${(product.quantity * product.price).toFixed(2)}</p>
                                            </div>
                        ...
                        <div className='lg:w-1/3'>
                            <div className='bg-white rounded-lg border border-gray-200 p-6 sticky top-8'>
                                ...
                                <div className='space-y-4 mb-6'>
                                    <div className='flex justify-between items-center'>
                                        <span className='text-gray-600'>Items ({cart.totalQuantity})</span>
                                ...
                                <button className='w-full bg-red-600 hover:bg-red-700 text-white py-3 px-4 rounded-lg font-semibold transition-colors duration-200 shadow-md hover:shadow-lg'>
                                    Proceed to Checkout
                                </button>
