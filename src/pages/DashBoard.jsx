...
const Dashboard = () => {
  ...
  const recentOrders = [
    { id: '#ORD-001', customer: 'John Doe', date: '2024-01-15', amount: '$234.00', status: 'Delivered' },
    { id: '#ORD-002', customer: 'Jane Smith', date: '2024-01-15', amount: '$156.00', status: 'Processing' },
    { id: '#ORD-003', customer: 'Mike Johnson', date: '2024-01-14', amount: '$89.00', status: 'Shipped' },
    { id: '#ORD-004', customer: 'Sarah Wilson', date: '2024-01-14', amount: '$345.00', status: 'Delivered' },
    { id: '#ORD-005', customer: 'Tom Brown', date: '2024-01-13', amount: '$67.00', status: 'Cancelled' },
  ];
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        <div className="bg-white rounded-xl shadow-sm p-6">
          <div className="flex items-center justify-between mb-6">
            ...
            <Link to="/dashboard/orders" className="text-blue-600 hover:text-blue-700 text-sm font-medium">
              View all
            </Link>
          </div>
